  ...
  render() {
    return (
      <div className="Projects">
        ...
        <div>
          <center>
            <img src="img/cnc/vision.png" alt="Code&amp;Craft's Vision" className="project-main-image"/>
          </center>
          <div className="project-overview" id="project-overview">
            <div className="project-info fivecol">
              <div />
              <div className="column1">
                <h1 className="project-title cnc-color">Code&amp;Craft Website Redesign Project</h1>
                <p>
              ...
              <div className="column2">
                <p className="projects-description">
                  <br/>
                  <p><b>Role: </b>UX/UI Designer<br/>
                  <b>Duration: </b>July - August 2019<br/>
                  <b>Other Teammates: </b>1 Developer, 2 Account Executives<br/>
                  <b>Tools: </b>Adobe Photoshop, Adobe XD</p>
                </p>
              </div>
              <div />
            </div>
            ...
            <div className="fivecol paddingtop50" id="project-background">
              ...
              <div className="project-background-box">
                ...
                <p>
                  ...
                  and I were tasked with <b>redesigning the Code&amp;Craft website</b> to fulfill the following objectives:<br/>
                  <b>easy to use, create new experience, good UX/UI, and better SEO</b>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="project-body">
            <div className="project-contribution fivecol paddingtop50" id="project-contribution">
              <div/>
              <div>
                <h2 className="cnc-color">My Contributions</h2>
            ...
            <div className="project-process threecol paddingtop50" id="project-process">
              <div/>
              <div><h2 className="cnc-color">Design Process</h2></div>
            </div>
            <center><img src="img/cnc/cnc_process.png" alt="Code&amp;Craft Design Process"/></center>

            <div className="project-problem threecol paddingtop50" id="project-problem">
              <div/>
              <div>
                <h2 className="cnc-color">Problem Statement</h2>
                <p className="cnc-project-box">
            ...
            <div className="project-research threecol paddingtop50" id="project-research">
              <div/>
              <div>
                <h2 className="cnc-color">Research</h2>
                <p className="cnc-project-box">
            ...
            <div className="project-ideation threecol paddingtop50" id="project-ideation">
              <div/>
              <div>
                <h2 className="cnc-color">Ideation</h2>
                <h3>Storyboarding</h3>
              </div>
            </div>
            <center>
            ...
            <div className="project-iteration threecol" id="project-iteration1">
              <div/>
              <div>
                <h3>Iteration 1</h3>
                <div className="cnc-project-box">
            ...
            <div className="project-iteration threecol" id="project-iteration2">
              <div/>
              <div>
                <h3>Iteration 2</h3>
                <div className="cnc-project-box">
            ...
            <div className="project-iteration threecol" id="project-iteration3">
              <div/>
              <div>
                <h3>Iteration 3</h3>
                <div className="cnc-project-box">
            ...
            <div className="project-brandguide threecol paddingtop150" id="project-brandguide">
              <div/>
              <div>
                <h3>Brand Guidelines</h3>
                <center>
                  <img src="img/cnc/moodboard.jpg" alt="Code&amp;Craft Moodboard"/>
                  <img src="img/cnc/photography.jpg" alt="Code&amp;Craft Photography Guide"/>
                  <img src="img/cnc/font.jpg" alt="Code&amp;Craft Font Guide"/>
                </center>
              </div>
            </div>

            <div className="project-solution threecol paddingtop50" id="project-solution">
              <div/>
              <div>
            ...
            <div className="project-next threecol paddingtop50" id="project-next">
              <div/>
              <div>
                <h2 className="cnc-color">Next Steps</h2>
                <p className="cnc-project-box">
            ...
            <div className="project-learn threecol paddingtop50" id="project-learn"> 
              <div/>
              <div>
                <h2 className="cnc-color">Lessons Learned</h2>
                <div className="threecol-forbox">
                  <div className="cnc-project-box">
